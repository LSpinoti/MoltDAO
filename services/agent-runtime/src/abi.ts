...
export const actionExecutorAbi = [
  ...
  {
    type: 'function',
    name: 'createRwaFundAction',
    stateMutability: 'nonpayable',
    inputs: [
      { name: 'postId', type: 'uint256' },
      { name: 'fundId', type: 'bytes32' },
      { name: 'amount', type: 'uint256' },
      { name: 'isAllocation', type: 'bool' },
      { name: 'deadline', type: 'uint256' },
    ],
    outputs: [{ name: 'actionId', type: 'uint256' }],
  },
  {
    type: 'function',
    name: 'createAgentWalletFundAction',
    stateMutability: 'nonpayable',
    inputs: [
      { name: 'postId', type: 'uint256' },
      { name: 'agent', type: 'address' },
  ...
  {
    type: 'function',
    name: 'createSwapProviderAction',
    stateMutability: 'nonpayable',
    inputs: [
      { name: 'postId', type: 'uint256' },
      { name: 'newProvider', type: 'address' },
      { name: 'providerNameHash', type: 'bytes32' },
      { name: 'deadline', type: 'uint256' },
    ],
    outputs: [{ name: 'actionId', type: 'uint256' }],
  },
  {
    type: 'function',
    name: 'createYieldStrategyAction',
    stateMutability: 'nonpayable',
    inputs: [
      { name: 'postId', type: 'uint256' },
      { name: 'strategyId', type: 'bytes32' },
      { name: 'allocationAmount', type: 'uint256' },
