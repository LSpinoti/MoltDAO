...
export const actionExecutorAbi = [
  ...
  {
    type: 'function',
    name: 'uniqueSupportersThreshold',
    stateMutability: 'view',
    inputs: [],
    outputs: [{ name: '', type: 'uint256' }],
  },
  ...
  {
    type: 'function',
    name: 'createGovernanceConfigAction',
    stateMutability: 'nonpayable',
    inputs: [
      { name: 'postId', type: 'uint256' },
      { name: 'supportStakeThreshold', type: 'uint256' },
      { name: 'uniqueSupportersThreshold', type: 'uint256' },
      { name: 'supportBpsThreshold', type: 'uint256' },
